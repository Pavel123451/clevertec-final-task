...
public interface CommentApi {
    ...
    CommentResponseDto getComment(@Valid @PathVariable Long commentId);


    @PutMapping("/{commentId}")
    CommentResponseDto updateComment(@PathVariable Long commentId,
                                     @Valid @RequestBody CommentCreateDto commentCreateDto);
    ...
    @GetMapping("/search")
    public PageResultDto<CommentResponseDto> searchComments(@RequestParam String text,
